...
|<img src="src/addon/www/config/img/devices/50/hb-rem-vivaldi_thumb.png" width=25/> | [HB-REM-VIVALDI](https://github.com/schmittst/JP-HB-Devices-addon/tree/vivaldi-remote) | Fernsteuerung für La-Spaziale-Vivaldi-II-Espressomaschine (Model-ID `0xF400`) _([schmittst](https://github.com/schmittst))_ | ⚡️ |
